...
def first_watch():
    result = Spacad_api.watch(EMAIL_SPACAD_SESSION, SESSION_SIGNATURE)
...
class TestUserSession:
    ...
    @pytest.mark.parametrize("email", [EMAIL_SPACAD_SESSION])
    def test_session_create_time(self, check_session, set_spacad_ad, first_watch, email):
